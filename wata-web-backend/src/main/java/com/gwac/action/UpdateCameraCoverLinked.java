 ...
 * @author xy
 */
public class UpdateCameraCoverLinked extends ActionSupport {

  private static final Log log = LogFactory.getLog(UpdateCameraCoverLinked.class);
  ...
  @Action(value = "updateCameraCoverLinked")
  public void upload() {
